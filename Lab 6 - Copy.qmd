...
Which model should you present to management?  - The better model is the multiplicative ETS model, based on the confidence interval and the metrics from the calibration table (try checking that).
